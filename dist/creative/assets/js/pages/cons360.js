...
=======
    ...
    var tipSol = document.getElementById('tipSol').value;
    displayLoading()
>>>>>>> a5b51c0b5c5d9bfcf13372c94a34a365925cee40
...
<<<<<<< HEAD
    ...
    .then(data => {
        if (data === '0001') {
            handleError("Cliento no existe");
        } else if (data === '0002') {
            handleError("Tarjeta no existe");
        } else {
...
function handleError(message) {
    hideLoading();
    $.NotificationApp.send("Error!", message, "top-right", "rgba(0,0,0,0.2)", "error");
    clearData();
}
